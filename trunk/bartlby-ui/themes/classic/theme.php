...
<link rel="stylesheet" id="CSS" type="text/css" href="themes/<?php echo $this->theme?>/btl.css"></link>
...
<body leftmargin=0 topmargin=0>
	<table width="100%" class="nopad">
		<tr>
			<td  class="bg_header"><a href='overview.php'><img border=0 src='themes/<?php echo $this->theme?>/images/btl-logo.gif'></A>
			...
			<div class="ui_performance" id="reload"><font size=1>UI-Version: <font size=1><?php echo $this->UIVERSION?></font> Page Render:<?php echo $this->BTUITIME?> secs &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->SERVERTIME?> &nbsp;&nbsp;&nbsp;&nbsp;</div>
				...
				<table class="nopad">
					<tr>
						<td class="navi">
							...
							<table class="nopad">
								<tr>
									<td><a target='_blank' href='http://wiki.bartlby.org/dokuwiki/doku.php'><img border=0 src='themes/<?php echo $this->theme?>/images/bartlby1-first-aid.gif'></A></td>
								</tr>
								<tr>
						...
						<td class="content">
							<table class="nopad">
								<tr>
									<td><?php echo $this->BTUIOUTSIDE?>
										<center>
										<table>
											<tr>
												<td>
													
													<font style='font-family:tahoma; font-size:8pt; color:#ffffff'><a href='http://www.bartlby.org/' target='_blank'>bartlby</A> is a GPLv2 product of <a href='http://www.januschka.com/' target='_blank'>januschka.com</A><?php echo $this->RELNOT?></font>
												</td>
											</tr>
										</table>
										</center>									
