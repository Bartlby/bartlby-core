namespace Nwc.XmlRpc
{
  ...
  public class XmlRpcRequest
  {
    ...
    WindowsApplication1.Properties.Settings st = new WindowsApplication1.Properties.Settings();

    NetworkCredential ncr = new NetworkCredential(st.Username, st.Password);
    request.Credentials = ncr;
